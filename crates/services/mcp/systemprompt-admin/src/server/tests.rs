...
mod tool_execution_tests {
    ...
    #[tokio::test]
    async fn test_tool_execution_response_returned_quickly() {
    ...
    #[tokio::test]
    async fn test_tokio_spawn_does_not_block() {
    ...
    #[tokio::test]
    async fn test_multiple_concurrent_spawns_fast() {
        let start = Instant::now();
    ...
    #[tokio::test]
    async fn test_error_in_spawned_task_does_not_panic() {
    ...
    #[tokio::test]
    async fn test_spawned_task_eventually_completes() {
    ...
    #[tokio::test]
    async fn test_cloning_primitives_for_spawn() {
...
#[cfg(test)]
mod non_blocking_pattern_tests {
    use std::sync::Arc;
    use std::time::Instant;
    use tokio::sync::Mutex;

    #[tokio::test]
    async fn test_non_blocking_pattern_basic() {
    ...
    #[tokio::test]
    async fn test_error_handling_in_spawned_task() {
    ...
    #[tokio::test]
    async fn test_multiple_operations_spawned() {
