---
title: "File Structure Playbook"
description: "Directory organization conventions for extensions and MCP servers."
keywords:
  - structure
  - files
  - directories
...
| Task | Command |
|------|---------|
| Check structure | `tree -I target extensions/{name}` |
| Find orphaned files | `find src -name "*.rs" \| xargs grep -L "mod "` |
| List SQL files | `ls schema/*.sql` |
| Check mod.rs coverage | Verify each directory has mod.rs |
