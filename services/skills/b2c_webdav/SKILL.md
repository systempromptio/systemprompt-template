...
- `b2c_logs` - Filtered log retrieval, search, and real-time tailing (preferred for log exploration)
- `b2c_code` - Higher-level code deployment (preferred for cartridge upload)
- `b2c_job` - Import/export site archives
