...
function processQueue() {
    var pending = CustomObjectMgr.queryCustomObjects('JobQueue', 'custom.status = {0}', 'creationDate asc', 'pending');
...
- `b2c_metadata` - Define custom object type metadata (attributes, XML import)
- `b2c_querying_data` - Query patterns and search models
- `b2c_scapi_shopper` - Shopper Custom Objects API from a composable storefront
