...
- `b2c_hooks` - Order hooks (calculate, payment, createOrderNo)
- `b2c_querying_data` - Efficient order query patterns (searchOrders/processOrders)
- `b2c_scapi_shopper` - Shopper Orders API from a composable storefront
