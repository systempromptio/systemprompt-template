...
- [Log Files](references/LOG-FILES.md) - Log file types, locations, retention, and limits

## Related Skills

- `b2c_logs` - Retrieve, filter, and tail instance logs via the b2c CLI
- `b2c_webdav` - Low-level WebDAV access to raw log files
