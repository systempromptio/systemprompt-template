...
b2c webdav get customerror-blade0-1-appserver-20240115.log --root=logs -o ./customerror.log
```

For filtered retrieval, search, and real-time tailing, prefer the `b2c logs` commands (see the `b2c-logs` skill).
