...
> **Note:** For **shopper-facing** APIs (products, baskets, checkout), see `b2c_scapi_shopper`. This skill focuses on **admin/backend** operations.
...
See `b2c_config` skill for configuration details.
...
- `b2c_config` - Get admin tokens via CLI
- `b2c_scapi_shopper` - Shopper-facing APIs
