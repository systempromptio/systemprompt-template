...
**Profile shows "User not found"** — The user ID in the URL does not match any user in the database. Verify the URL parameter is correct.

**No gamification data showing** — Gamification data is calculated from your activity. If you are a new user with no events, gamification stats will not appear until you start using the platform.

**Achievements section missing** — You have not unlocked any achievements yet. Continue using the platform to earn XP and unlock achievements.

**Activity shows "No activity recorded"** — No events have been recorded for your user account. This may occur for newly created accounts or if event tracking is not yet configured.
