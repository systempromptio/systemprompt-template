...
The platform license grants systemprompt.io 12 months of production use of the core systemprompt platform — the AI governance engine. This includes:
...
| **Infrastructure costs** | Hosting on systemprompt.io infrastructure is systemprompt.io's responsibility |
| **Extension codebase** | The Control Center is owned by systemprompt.io — it is not part of the platform license |
...
The core platform is licensed under the **Business Source License 1.1 (BSL-1.1)** — the source code is fully available for auditing. systemprompt.io can inspect every line of the licence enforcement logic. Source-available means full transparency with no obfuscation.
...
It does **not** cover the Control Center extension codebase. That code is [owned by systemprompt.io](/documentation/engagement-implementation) and is not subject to the platform license. systemprompt.io retains the Control Center regardless of whether the platform license is renewed.
...
- The Control Center extension code remains systemprompt.io's property regardless of renewal
- All skills, agents, configurations, and data created during the term remain with systemprompt.io
