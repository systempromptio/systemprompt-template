...
/// Parameters for creating a new campaign link.
#[derive(Debug, Clone)]
...
impl CreateLinkParams {
    /// Create new link parameters with required fields.
...
/// Parameters for recording a click event.
#[derive(Debug, Clone)]
...
/// Parameters for tracking a click (simplified version).
#[derive(Debug, Clone)]
