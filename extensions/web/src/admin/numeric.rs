...
pub const fn to_f32_from_i64(v: i64) -> f32 {
    v as f64 as f32
}
...
pub const fn seconds_to_f64(v: i64) -> f64 {
    v as f64
}
...
pub const fn i64_to_usize(v: i64) -> usize {
    v as usize
}
...
pub const fn usize_to_i64(v: usize) -> i64 {
    v as i64
}
