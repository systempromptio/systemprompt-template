...
pub async fn my_activity_page(
    ...
    let gamification = crate::admin::gamification::queries::find_user_gamification(
        &pool,
    ...
    let achievement_stats = crate::admin::gamification::queries::get_achievement_stats(&pool)
        .await
        .unwrap_or_else(|e| {
    ...
    let total_count = crate::admin::gamification::ACHIEVEMENTS.len();
...
fn build_lookups<'a>(
    gamification: Option<&'a crate::admin::types::UserGamificationProfile>,
...
fn build_achievements_by_category(
    ...
    stats: &[crate::admin::types::AchievementInfo],
