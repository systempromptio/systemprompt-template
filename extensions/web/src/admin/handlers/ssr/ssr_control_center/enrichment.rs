...
pub fn enrich_session_groups(
    ...
    session_ratings: &[crate::admin::types::conversation_analytics::SessionRating],
    entity_links: &[(
        String,
        crate::admin::types::conversation_analytics::SessionEntityLink,
    )],
) {
    let ratings_map: HashMap<String, &crate::admin::types::conversation_analytics::SessionRating> =
        session_ratings
            .iter()
...
fn enrich_single_group(
    ...
    ratings_map: &HashMap<String, &crate::admin::types::conversation_analytics::SessionRating>,
