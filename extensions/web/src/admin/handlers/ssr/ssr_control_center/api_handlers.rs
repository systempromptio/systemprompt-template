...
use crate::admin::handlers::hooks_track::ai_summary;
...
pub(crate) async fn handle_rate_session(
    ...
    match crate::admin::repositories::conversation_analytics::upsert_session_rating(
        &pool,
        &user_ctx.user_id,
        &req.session_id,
        req.rating,
...
pub(crate) async fn handle_rate_skill(
    ...
    match crate::admin::repositories::conversation_analytics::upsert_skill_rating(
        &pool,
        &user_ctx.user_id,
        &req.skill_name,
        req.rating,
...
pub(crate) async fn handle_analyse_session(
    ...
    State(pool): State<Arc<PgPool>>,
    Json(req): Json<crate::admin::types::control_center::AnalyseSessionRequest>,
) -> Response {
...
pub(crate) async fn handle_generate_report(
    ...
    match crate::jobs::daily_summary::generate::generate_user_daily_summary(
        &pool,
