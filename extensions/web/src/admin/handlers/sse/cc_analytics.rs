...
struct FetchedAnalytics {
    skill_eff_res:
        Result<Vec<crate::admin::types::conversation_analytics::SkillEffectiveness>, sqlx::Error>,
...
async fn build_entity_data(
    ...
    let entity_usage =
        crate::admin::repositories::conversation_analytics::fetch_entity_usage_summary(
            pool, user_id,
        )
        .await
...
fn build_achievement_progress(
    ...
    mcp_usage: &[&crate::admin::types::conversation_analytics::EntityUsageSummary],
