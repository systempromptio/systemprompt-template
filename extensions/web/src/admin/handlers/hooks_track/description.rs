...
fn describe_user_prompt(d: &crate::admin::types::webhook::UserPromptSubmitData) -> String {
...
fn describe_post_tool_failure(d: &crate::admin::types::webhook::PostToolUseFailureData) -> String {
...
fn describe_post_tool_use(d: &crate::admin::types::webhook::PostToolUseData) -> String {
    let tool = if d.tool_name.is_empty() {
        "unknown"
    } else {
        &d.tool_name
...
fn describe_permission_request(d: &crate::admin::types::webhook::PermissionRequestData) -> String {
    let tool = if d.tool_name.is_empty() {
        "unknown"
    } else {
        &d.tool_name
...
fn describe_session_start(d: &crate::admin::types::webhook::SessionStartData) -> String {
...
fn describe_session_end(d: &crate::admin::types::webhook::SessionEndData) -> String {
...
fn describe_stop(d: &crate::admin::types::webhook::StopData) -> String {
...
fn describe_subagent_stop(d: &crate::admin::types::webhook::SubagentStopData) -> String {
    match &d.last_assistant_message {
...
fn describe_task_completed(d: &crate::admin::types::webhook::TaskCompletedData) -> String {
...
fn describe_teammate_idle(d: &crate::admin::types::webhook::TeammateIdleData) -> String {
    format!("Teammate idle: {}", d.teammate_name)
}

fn describe_notification(d: &crate::admin::types::webhook::NotificationData) -> String {
...
fn describe_config_change(d: &crate::admin::types::webhook::ConfigChangeData) -> String {
...
fn describe_worktree_create(d: &crate::admin::types::webhook::WorktreeCreateData) -> String {
    format!("Worktree created: {}", d.name)
}

fn describe_worktree_remove(d: &crate::admin::types::webhook::WorktreeRemoveData) -> String {
    format!("Worktree removed: {}", d.worktree_path)
}

fn describe_pre_compact(d: &crate::admin::types::webhook::PreCompactData) -> String {
...
fn describe_instructions_loaded(
    d: &crate::admin::types::webhook::InstructionsLoadedData,
) -> String {
