...
// ============================================================================
// BlogPostPageDataProvider - provides template variables for individual posts
// ============================================================================
...
impl PageDataProvider for BlogPostPageDataProvider {
    ...
    async fn provide_page_data(&self, ctx: &PageContext<'_>) -> Result<Value> {
        ...
        if let Some(obj) = data.as_object_mut() {
            ...
            // Image - map to both FEATURED_IMAGE and IMAGE for template compatibility
            ...
            if let Some(content) = item.get("content").and_then(|v| v.as_str()) {
                ...
                let read_time = (word_count / 200).max(1); // ~200 words per minute
                obj.insert(
                    "READ_TIME".to_string(),
            ...
            // Get slug and title for social/related sections
            ...
            // Related Posts - fetch from database
...
// ============================================================================
// Related Post struct for queries
// ============================================================================
...
fn render_social_action_bar(_slug: &str, _title: &str, _org_url: &str) -> String {
    // Social links - these link to our profiles, not share URLs
    let social_links = [
        ("github", "https://github.com/systempromptio"),
        ("twitter", "https://twitter.com/systemprompt"),
        ("linkedin", "https://www.linkedin.com/company/systempromptio"),
    ];
    ...
    // Add share button with Web Share API fallback to clipboard
...
fn render_references(links: &Value) -> Option<String> {
...
fn render_related_posts(posts: &[RelatedPost]) -> Option<String> {
    if posts.is_empty() {
        return None;
    }
