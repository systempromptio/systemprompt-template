...
fn css_assets(storage_css: &Path) -> Vec<AssetDefinition> {
    vec![
        ...
        AssetDefinition::css(storage_css.join("homepage-demo.css"), "css/homepage-demo.css"),
        AssetDefinition::css(storage_css.join("homepage-sections.css"), "css/homepage-sections.css"),
        AssetDefinition::css(storage_css.join("homepage-playbooks.css"), "css/homepage-playbooks.css"),
        ...
        AssetDefinition::css(storage_css.join("blog-typography.css"), "css/blog-typography.css"),
        ...
        AssetDefinition::css(storage_css.join("content-cards.css"), "css/content-cards.css"),
