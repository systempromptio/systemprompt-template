-- Migration 016: Gamification system tables
-- Adds XP tracking, ranks, achievements, and daily usage for streak calculation

-- XP bonus ledger for non-event-based XP (bonuses, achievements, streaks)
...
-- Materialized rank cache (updated by background job)
...
-- Daily usage tracking for streak calculation
