...
pub struct TierEnforcementCache {
    tier_cache: Arc<RwLock<HashMap<UserId, CachedTierContext>>>,
    usage_cache: Arc<RwLock<HashMap<UserId, CachedUsageSnapshot>>>,
}
...
impl TierEnforcementCache {
    ...
    pub async fn plan_name(&self, user_id: &UserId) -> Arc<str> {
