...
//! and a row of a type the matrix rendered was invisible to the resolver as a
//! direct result. Core owns `user` and `role`; the rest are minted by the
//! providers in [`crate::authz`].
