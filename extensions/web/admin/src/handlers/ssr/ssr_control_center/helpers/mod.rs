...
pub(super) struct AnalyticsData {
    pub skill_effectiveness: Vec<crate::types::conversation_analytics::SkillEffectiveness>,
    pub entity_usage: Vec<crate::types::conversation_analytics::EntityUsageSummary>,
    pub session_ratings: Vec<crate::types::conversation_analytics::SessionRating>,
    pub skill_ratings: Vec<crate::types::conversation_analytics::SkillRating>,
...
pub(super) async fn fetch_control_center_data(
    ...
    Vec<crate::types::control_center::RecentSession>,
    crate::types::control_center::TodayStats,
    control_center::TodayOutcomeStats,
    Vec<crate::types::ToolUsageCount>,
    AnalyticsData,
