...
pub async fn my_skills_page(
    ...
    super::render_typed_page(&engine, "my-skills", &data, &user_ctx, &mkt_ctx)
}
...
pub async fn my_skill_edit_page(
    ...
    super::render_typed_page(&engine, "my-skill-edit", &data, &user_ctx, &mkt_ctx)
}
    ...
    skill.map_or_else(
        || {
            serde_json::to_value(&SkillEditView {
                skill_id: SkillId::new(String::new()),
                name: String::new(),
