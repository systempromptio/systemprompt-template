...
use crate::types::{CreateUserHookRequest, UpdateUserHookRequest, UserContext};
use axum::{
...
use crate::handlers::{responses::HooksListResponse, shared};
...
pub async fn create_user_hook_handler(
    ...
    let limit_check = crate::tier_enforcement::check_limit(
        ...
        pool.as_ref(),
        &user_ctx.user_id,
        crate::tier_limits::LimitCheck::CreateHook,
    )
    .await;
