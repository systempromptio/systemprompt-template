...
//! overrides and per-user skill / device counts.
...
// Why: Per-user overrides only. Group- and role-scoped rules reach a user
// through the resolver, not through this listing.
