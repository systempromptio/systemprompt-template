...
/// Distinct values for the model / provider / status dropdowns on the
/// requests page. Aggregated over the same window the page renders so the
/// dropdowns only show options that appear in the current view.
