...
use crate::repositories::github_sync_git::{
...
async fn prepare_publish_content(
    ...
    let export = crate::repositories::export::generate_org_marketplace_export_bundles(
        services_path,
        pool,
        marketplace_id,
        "linux",
...
async fn log_publish_result(input: &PublishLogInput<'_>) {
    let _ = crate::repositories::org_marketplaces::insert_sync_log(
        input.pool,
        &crate::repositories::org_marketplaces::SyncLogEntry {
