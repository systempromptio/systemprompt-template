use crate::repositories::export::{ManifestAuthor, MarketplaceManifest, MarketplacePluginEntry};
use systemprompt_web_shared::error::MarketplaceError;

pub(super) fn build_marketplace(
    plugin_configs: &[(String, crate::types::PlatformPluginConfig)],
    bundles: &[crate::repositories::export::PluginBundle],
    username: &str,
    email: &str,
) -> Result<crate::repositories::export::MarketplaceFile, MarketplaceError> {
    ...
    Ok(crate::repositories::export::MarketplaceFile {
...
fn build_org_plugin_entry(
    plugin: &crate::types::PlatformPluginConfig,
    bundles: &[crate::repositories::export::PluginBundle],
) -> MarketplacePluginEntry {
    let version = bundles
        .iter()
        .find(|b| plugin.base.id.as_str() == b.id)
        .map_or_else(|| plugin.base.version.clone(), |b| b.version.clone());
    MarketplacePluginEntry {
        name: plugin.base.id.to_string(),
