...
use crate::repositories::export::{PluginBundle, SyncPluginsResponse};
...
pub fn build_cowork_plugin_zip(
    ...
    let merged_files = crate::repositories::cowork_sanitize::sanitize_for_cowork(
        &merged_files,
        params.platform_url,
        &cowork_token,
        &description,
    ...
    let counts = crate::repositories::export_validation::compute_bundle_counts(&merged_files);
...
fn append_merged_mcp_config(
    ...
    use crate::repositories::export::{McpConfigFile, McpServerEntry, PluginFile};
