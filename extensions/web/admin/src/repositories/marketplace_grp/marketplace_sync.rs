...
use crate::types::{ParsedSkill, SyncDiff, UserSkill};
use systemprompt_web_shared::error::MarketplaceError;

pub use crate::repositories::marketplace_sync_archive::extract_archive;
pub use crate::repositories::marketplace_sync_parse::parse_skills_from_directory;
...
pub async fn compute_skill_diff(
    ...
    let existing = crate::repositories::user_skills::list_user_skills(pool, user_id).await?;
...
pub async fn snapshot_current_skills(
    ...
    let skills = crate::repositories::user_skills::list_user_skills(pool, user_id).await?;
