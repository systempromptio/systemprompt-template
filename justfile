...
# Publish static assets (admin templates, CSS/JS bundles, copy to web/dist)
publish:
    {{CLI}} infra jobs run compile_admin_templates
    {{CLI}} infra jobs run bundle_admin_css
    {{CLI}} infra jobs run bundle_admin_js
    {{CLI}} infra jobs run copy_extension_assets
    {{CLI}} infra jobs run content_prerender
    {{CLI}} infra jobs run page_prerender
