...
const buildEntityInfo = (entity, entityType) => {
  ...
  badgeWrap.className = 'sp-acl-badge-row';
  const typeBadge = document.createElement('span');
  typeBadge.className = 'badge badge-blue';
  typeBadge.textContent = entityType.replace('_', ' ');
  badgeWrap.append(typeBadge);
  badgeWrap.append(document.createTextNode(' '));
...
const buildRolesSection = (entity) => {
  ...
  desc.textContent = 'Select which roles can access this entity.';
  section.append(desc);
...
const buildPanelContent = (entity, entityType) => {
  const frag = document.createDocumentFragment();
  frag.append(buildEntityInfo(entity, entityType));
  frag.append(buildRolesSection(entity));
  return frag;
};
