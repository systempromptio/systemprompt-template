...
export const initReportActions = () => {
  ...
  if (printBtn) {
    printBtn.addEventListener('click', () => {
      ...
      const wasHidden = reportTab && !reportTab.classList.contains('cc-tab-panel--active');
      if (wasHidden) reportTab.classList.add('cc-tab-panel--active');
      renderSparklines();
      window.print();
      if (wasHidden) reportTab.classList.remove('cc-tab-panel--active');
    });
  }
