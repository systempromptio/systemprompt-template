...
const initTabs = () => {
  for (const tab of document.querySelectorAll('.dashboard-tabs .cc-tab')) {
    tab.addEventListener('click', () => {
      ...
      for (const t of document.querySelectorAll('.dashboard-tabs .cc-tab')) t.classList.remove('cc-tab--active');
...
const initFilterAjax = () => {
  document.addEventListener('click', async (e) => {
    ...
    if (targetPanel) targetPanel.classList.add('cc-tab-panel--loading');
    ...
    try {
      ...
      if (targetPanel) targetPanel.classList.remove('cc-tab-panel--loading');
    }
  });
};
