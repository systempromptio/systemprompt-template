---
name: "Odoo Frontend"
description: "Create high-quality HTML content compatible with Odoo Editor using Bootstrap 5 and the Enterprise Demo design system"
---
...
2. **Header**: Logo on dark background (`#1A0030`)
