...
- **Screenshots:** `../storage/files/images/evidence/req-001-users-roster.png`, `../storage/files/images/evidence/req-001-user-detail.png`
...
- **Screenshots:** `../storage/files/images/evidence/req-002-login-invite-only.png`
...
- **Specs:** `@REQ-003` · **Screenshots:** `../storage/files/images/evidence/req-003-usage-trends.png`, `../storage/files/images/evidence/req-003-overview.png`
...
- **Specs:** `@REQ-004` · **Screenshots:** `../storage/files/images/evidence/req-004-spend.png`, `../storage/files/images/evidence/req-004-model-mix.png`
...
- **Specs:** `@REQ-005` · **Screenshots:** `../storage/files/images/evidence/req-005-seats.png`, `../storage/files/images/evidence/req-005-inactive-seats.png`
...
- **Specs:** `@REQ-006` (the three real dimensions) · **Screenshots:** `../storage/files/images/evidence/req-006-drilldown.png`, `../storage/files/images/evidence/req-006-user-drilldown.png`
...
- **Screenshot:** `../storage/files/images/evidence/req-007-008-code-tab.png` (evidence of the labelling, not of compliance)
...
- **Screenshot:** `../storage/files/images/evidence/req-007-008-code-tab.png`
...
- **Specs:** `@REQ-009` · **Screenshots:** `../storage/files/images/evidence/req-009-spend-meters.png`
