...
pub struct StorageConfig {
    ...
    /// Default: ${`STORAGE_PATH}/generated_images` (typically
    /// /`app/storage/generated_images` in production)
...
impl Default for StorageConfig {
    fn default() -> Self {
        ...
        Self {
            base_path: PathBuf::from(storage_base).join("images/generated"),
            url_prefix: "/files/images/generated".to_string(),
