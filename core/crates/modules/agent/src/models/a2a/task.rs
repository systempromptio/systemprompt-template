...
pub struct Task {
    ...
    pub id: TaskId,
    /// A server-generated unique identifier for maintaining context across related tasks
    #[serde(rename = "contextId")]
    pub context_id: ContextId,
    /// The current status of the task, including its state and descriptive message
...
pub struct TaskStatus {
    ...
    /// ISO 8601 datetime when this status was recorded (serde serializes to string)
